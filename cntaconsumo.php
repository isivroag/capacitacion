    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header bg-gradient-green text-light">
                <h1 class="card-title mx-auto">VALES DE CONSUMO</h1>
            </div>
                                ...
                                <div class="row justify-content">
                                    <div class="col-sm-4">
                                        <div class="form-group input-group-sm">
                                            ...
                                            <input type="hidden" class="form-control" name="foliocons" id="foliocons">
...
<script src="fjs/cntaconsumo.js?v=<?php echo (rand()); ?>"></script>
