...
$consulta = "SELECT * FROM umedida WHERE estado_umed=1 ORDER BY id_umed";
            ...
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-gradient-green">
                        <h5 class="modal-title" id="exampleModalLabel">NUEVA U DE MEDIDA</h5>
...
<script src="fjs/cntaumedida.js?v=<?php echo (rand()); ?>"></script>
