...
if (isset($_GET['id'])) {
    ...
    echo "window.location='cntainsumo.php'";
    echo "</script>";
}
...
if (isset($_GET['fechaini']) && isset($_GET['fechafin'])){
    ...
    $consulta = "SELECT * FROM insumo_mov where estado_reg=1 AND id_ins='$id' and fecha between '$fechaini' and '$fechafin' order by fecha desc,id_reg desc";
}
else{
    $consulta = "SELECT * FROM insumo_mov where estado_reg=1 AND id_ins='$id' order by fecha desc,id_reg desc";
}
    ...
    <section class="content">
        ...
        <div class="card ">
            <div class="card-header bg-gradient-secondary">
                <h4 class="card-title text-center">KARDEX DE INSUMOS</h4>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group input-group-sm">
                                    <label for="claveitem" class="col-form-label">CLAVE :</label>
                            ...
                            <div class="table-responsive">
                                <table name="tablaV" id="tablaV" class="table table-hover table-sm table-striped table-bordered table-condensed text-nowrap w-auto mx-auto" style="font-size:15px;">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $rowdata['id_reg'] ?></td>
                                                <td><?php echo $rowdata['fecha'] ?></td>
...
<script src="fjs/kardexins.js?v=<?php echo (rand()); ?>"></script>
